        ...
        {items.map((c) => {
          ...
          return (
            <Link
              ...
              className="group block rounded-2xl border-2 border-slate-200 bg-white p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#0f766e] hover:shadow-md active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2 sm:p-6"
            >
              ...
              <div className="mt-3 h-1.5 w-full overflow-hidden rounded-full bg-slate-100">
                <div
                  ...
                  style={{
                    background: "#0f766e",
                    width: `${Math.max(0, Math.min(100, c.porcentaje))}%`,
                  }}
                />
              </div>
              ...
              <span className="mt-5 inline-flex w-full items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-all duration-200 sm:w-auto" style={{ background: "#0f766e" }}>
                Ver avance →
              </span>
            </Link>
          );
