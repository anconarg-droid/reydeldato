-- =============================================================================
-- OBLIGATORIO para ubicación precisa en ficha / mapas
-- =============================================================================
-- Añade `lat` / `lng` a `public.emprendedor_locales` y los expone en el JSON `locales`
-- de `public.vw_emprendedores_publico`. Sin aplicar esta migración, los INSERT con
-- lat/lng fallan y la ficha no recibe coordenadas.
-- Idempotente: columnas IF NOT EXISTS; DROP + CREATE de la vista (misma definición
-- que 20260430230000 + claves lat/lng en jsonb_agg).
-- =============================================================================
...
COMMENT ON COLUMN public.emprendedor_locales.lat IS 'Latitud WGS84 opcional; si viene con lng, Google Maps en ficha usa destino por coordenadas.';
COMMENT ON COLUMN public.emprendedor_locales.lng IS 'Longitud WGS84 opcional; par con lat.';
