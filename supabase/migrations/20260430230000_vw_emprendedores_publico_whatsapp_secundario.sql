-- =============================================================================
-- Vista pública: vw_emprendedores_publico
-- =============================================================================
-- Alineada al esquema real de `public.emprendedores` documentado en
-- supabase/docs/EMPRENDEDORES_ESQUEMA_REAL.md
-- - Sin: nombre, comuna_base_id, descripcion_corta, descripcion_larga,
--   nivel_cobertura, subcategorias_slugs, whatsapp, web (tabla).
-- - Alias de contrato: nombre, comuna_base_id, descripcion_corta, descripcion_larga,
--   nivel_cobertura, subcategorias_slugs.
-- Si `emprendedor_locales` quedó sin columnas esperadas (p. ej. tabla vieja), se
-- añaden aquí de forma idempotente antes de crear la vista.
-- Si al recrear la vista Postgres devuelve "cannot change name of view column",
-- usar DROP + CREATE (no OR REPLACE) cuando cambia el orden/nombre de columnas.
-- Si otra vista depende de esta, DROP puede exigir CASCADE (evaluar antes).
-- =============================================================================

ALTER TABLE public.emprendedor_locales
