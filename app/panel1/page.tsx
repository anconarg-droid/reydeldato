import Panel1Client from "./panel1-client";
import PanelEnlaceVencidoClient from "@/app/panel/PanelEnlaceVencidoClient";
...
export default async function Page({
  ...
  return (
    <Panel1Client
      ...
      esPremium={false}
      pagoResult={pago === "exito" ? "exito" : pago === "fallo" ? "fallo" : null}
    />
  );
}
