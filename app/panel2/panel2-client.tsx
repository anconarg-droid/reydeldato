...
import PanelDashboardLayoutPanel2 from "@/components/panel/PanelDashboardLayoutPanel2";
...
export default function Panel2Client({
  id,
  slug,
  accessToken,
  mejorarFichaFocus,
  ...
  const tuNegocio = (
    <div
      className="rounded-xl border border-gray-200 bg-gradient-to-br from-white via-gray-50/80 to-gray-50/40 px-4 py-3 shadow-sm ring-1 ring-gray-900/[0.04] sm:px-5 sm:py-3.5"
  ...
  const planActual = tieneNegocio ? (
    <section className="rounded-xl border border-gray-200 bg-white p-3 shadow-sm sm:p-3.5">
      {(() => {
        if (fichaLoading) {
          return (
  ...
  const progresoFicha = tieneNegocio ? (
    <div className="rounded-xl border border-gray-200 bg-gray-50/90 px-4 py-3 shadow-sm">
