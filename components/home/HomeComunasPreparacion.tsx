  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-2xl text-sm text-slate-600">
        Oportunidad: tu publicación ayuda a abrir la comuna antes.
      </p>

      <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
        {items.map((c) => {
          const totalFaltan = c.faltantesTop.reduce(
          ...
          const faltanLine =
            totalFaltan > 0
              ? totalFaltan === 1
                ? "Falta 1 para abrir"
                : `Faltan ${totalFaltan} para abrir`
              : "Falta completar rubros para abrir.";
