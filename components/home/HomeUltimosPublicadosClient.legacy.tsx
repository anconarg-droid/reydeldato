...
export default function HomeUltimosPublicadosClient({ cards }: Props) {
    ...
    <div className="w-full" aria-labelledby="home-ultimos-publicados-heading">
      <div className="mx-auto w-full max-w-5xl px-0">
        <h2
          ...
          className="text-center text-lg font-medium tracking-tight text-slate-800 sm:text-xl md:text-2xl"
        >
