...
Buscas en Google`}
        ...
        <figure className="mt-12 sm:mt-14 mx-auto max-w-3xl rounded-2xl border border-emerald-200/80 bg-emerald-50 px-6 py-5 sm:px-8 sm:py-6">
          <blockquote className="text-center text-emerald-900 text-base sm:text-lg leading-snug font-semibold tracking-tight">
      ...
      <section className="border-t border-slate-100/80 bg-slate-50" aria-labelledby="home-solucion">
        ...
        <div className="mt-6 max-w-3xl space-y-4 text-slate-700 leading-relaxed">
          ...
          <p className="text-sm sm:text-base font-semibold text-emerald-700 pt-1">
      ...
      <section className="border-t border-slate-100/80 bg-white" aria-labelledby="home-plataforma-real">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <div className="rounded-2xl border border-emerald-200/80 bg-emerald-50/60 py-12 px-6 sm:px-10 sm:py-14 shadow-sm">
      ...
      <section className="border-t border-slate-100/80 bg-slate-50" aria-labelledby="home-como-funciona">
        ...
        <ol className="mt-8 grid grid-cols-1 gap-y-8 gap-x-6 sm:grid-cols-2 sm:gap-y-10 sm:gap-x-6">
          {[
            ...
            <li key={step.n} className="rounded-xl border border-slate-200 bg-white p-5 sm:p-6 shadow-sm transition-shadow duration-200 hover:shadow-md border-l-4 border-l-emerald-500">
              <div className="text-xs font-semibold tracking-wide text-emerald-600">{step.n}</div>
      ...
      <section className="border-t border-slate-100/80 bg-white" aria-labelledby="home-diferencia">
        ...
        <div className="mt-10 sm:mt-12 grid gap-4 sm:grid-cols-2">
          {[
            ...
            <div key={x.t} className="rounded-xl border border-slate-200 bg-white p-5 sm:p-6 shadow-sm transition-shadow duration-200 hover:shadow-md border-l-4 border-l-emerald-500">
              <div className="text-sm font-semibold text-emerald-700">{x.t}</div>
              <p className="mt-2 text-sm text-slate-700 leading-relaxed whitespace-pre-line">{x.d}</p>
            </div>
          ))}
        </div>
        <p className="mt-12 sm:mt-14 text-center text-sm font-semibold text-emerald-700">
      ...
      <section className="border-t border-slate-100/80 bg-white" aria-labelledby="home-ejemplos">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link href="/comunas" className="text-sm font-semibold text-emerald-700 underline underline-offset-4 hover:text-emerald-800">
            Ver comunas
          </Link>
        </div>
            ...
            {loadingCategorias ? (
              ...
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 sm:gap-3">
                {categoriasHome.map((cat) => (
                  <div
                    key={cat.slug}
                    className="rounded-xl border border-slate-100 bg-slate-50/50 p-2.5 sm:p-3 flex flex-col shadow-sm transition-all duration-200 hover:border-emerald-200 hover:bg-white hover:shadow-md"
                  >
                    <Link
                      href={`/buscar?categoria=${encodeURIComponent(cat.slug)}`}
                      className="block min-w-0 text-slate-600 transition hover:text-emerald-700"
                    >
